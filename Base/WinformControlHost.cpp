#include "..\\stdafx.h"
#include "..\\include\\Base\\WinformControlHost.h"
...
NativeBase* WinformControlHost::GetNative()
{
	return m_native;
}

void WinformControlHost::SetNative(NativeBase *native)
{
	m_native = native;
}
...
void WinformControlHost::BeginInvoke( ControlA *control, void *args )
{
...
ControlA* WinformControlHost::CreateInternalControl( ControlA *parent, const String& clsid )
{
...
CursorsA WinformControlHost::GetCursor()
{
	CursorsA cursorsA = CursorsA_No;
	return cursorsA;
}
...
void WinformControlHost::Invoke( ControlA *control, void *args )
{
...
void WinformControlHost::SetCursor( CursorsA cursor )
{
